...
CREATE UNIQUE INDEX "auth_accounts_provider_id_account_id_unique_idx" ON "auth_accounts" USING btree ("provider_id","account_id");--> statement-breakpoint
CREATE INDEX "auth_sessions_userId_idx" ON "auth_sessions" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "auth_users_email_lower_unique_idx" ON "auth_users" USING btree (lower("email"));--> statement-breakpoint
